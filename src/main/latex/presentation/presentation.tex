...
\section{Development Libraries}
  ...
  \begin{frame}{Libraries for Specific Use Cases}
    ...
    \begin{frame}{UI Libraries and Widgets}
      \begin{description}
        \item<1->[GreenDroid \surl{https://github.com/cyrilmottier/GreenDroid}] dfdf
        \item<2->[svg-android \surl{http://code.google.com/p/svg-android/}] dfdf
        \item<3->[View Flow for Android \surl{https://github.com/pakerfeldt/android-viewflow}] dfdf
        \item<4->[ActionBarSherlock \surl{http://actionbarsherlock.com/}]  dfdf
        \item<5->[Android Wheel \surl{http://code.google.com/p/android-wheel/}] dfdf
        \item<6->[Android Actionbar \surl{https://github.com/johannilsson/android-actionbar}] dfdf
      \end{description}
    \end{frame}
