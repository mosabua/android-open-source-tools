...
\begin{frame}{About Manfred}
  \begin{itemize}
    ...
    \item<3-> Project lead ksoap2-android
    \item<4-> Committer RoboGuice
    \item<5-> Committer Hudson
    \item<6-> Book author, presenter and consultant
    \item<7-> Leader of Vancouver Island JUG, BC, Canada
    \item<8-> Twitter @simpligility , G+ Manfred Moser
  \end{itemize}
